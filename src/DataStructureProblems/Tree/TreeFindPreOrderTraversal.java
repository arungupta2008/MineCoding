 ...
 */
public class TreeFindPreOrderTraversal {
    ...
    public static void main(String args[]) {
        TreeFindPreOrderTraversal bst = new TreeFindPreOrderTraversal();
        ...
        int[] pre3 = new int[]{40, 30, 20, 35, 80, 100};
        int n2 = pre3.length;
        if (bst.canRepresentBST(pre3, n2) == true) {
            System.out.println("true");
        } else {
            System.out.println("false");
        }
